package com.dnr2144.csmoa.config.secret;
...
public class Secret {
    ...
    public static final SecretKey SIGNED_KEY = Keys.hmacShaKeyFor(Secret.JWT_SECRET_KEY.getBytes(StandardCharsets.UTF_8));
}
